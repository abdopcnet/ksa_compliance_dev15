frappe.ui.form.on('ZATCA Business Settings', {
	...
	perform_compliance_checks: function (frm) {
		...
		let simplified =
			frm.doc.type_of_business_transactions === 'Let the system decide (both)' ||
...
function filter_company_address(frm) {
	frappe.call({
		method: 'ksa_compliance.ksa_compliance.doctype.zatca_business_settings.zatca_business_settings.fetch_company_addresses',
		args: {
